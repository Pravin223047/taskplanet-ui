...
interface FacebookTaskModalProps {
  isFacebookOpen: boolean;
  onClose: () => void;
}

const FacebookTaskModal: React.FC<FacebookTaskModalProps> = ({
  isFacebookOpen,
  onClose,
}) => {
  ...
  const visitTask = () => {
    if (selectedTask) {
      const taskURLs: Record<string, string> = {
        like: "/facebook-post-like",
        comment: "/facebook-post-comment",
        follow: "/facebook-profile-follow",
      };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="relative bg-white w-full max-w-4xl p-4 sm:p-6 md:p-8 rounded-lg shadow-lg overflow-y-auto">
            ...
            <div
              ...
              className={`mb-4 sm:mb-6 bg-yellow-100 border border-yellow-300 rounded-lg p-4 sm:p-6 flex flex-col sm:flex-row items-center cursor-pointer ${
                selectedTask === "like" ? "ring-4 ring-yellow-500" : ""
              }`}
            >
              <input
                type="radio"
              ...
              <div className="hidden sm:block w-full sm:w-1/2">
                ...
                <p className="text-gray-700 mt-2 text-sm sm:text-base">
                  Like Any Post on Facebook & Earn Exciting Rewards & Points
                </p>
              </div>
              <div className="w-full sm:w-1/2 mt-4 sm:mt-0">
                <img
                  src="/Facebook/facebookimage1.png"
                  alt="Like Post"
            ...
            <div
              ...
              className={`mb-4 sm:mb-6 bg-red-100 border border-red-300 rounded-lg p-4 sm:p-6 flex flex-col sm:flex-row items-center cursor-pointer ${
                selectedTask === "comment" ? "ring-4 ring-red-500" : ""
              }`}
            >
              <input
                type="radio"
              ...
              <div className="hidden sm:block w-full sm:w-1/2">
                ...
                <p className="text-gray-700 mt-2 text-sm sm:text-base">
                  Comment on Any Post on Facebook & Earn Exciting Rewards &
                  Points
                </p>
              </div>
              <div className="w-full sm:w-1/2 mt-4 sm:mt-0">
                <img
                  src="/Facebook/facebookimage2.png"
                  alt="Comment on Post"
                  className="w-full rounded-lg"
                />
              </div>
            ...
            <div
              ...
              className={`mb-4 sm:mb-6 bg-blue-100 border border-blue-300 rounded-lg p-4 sm:p-6 flex flex-col sm:flex-row items-center cursor-pointer ${
                selectedTask === "follow" ? "ring-4 ring-blue-500" : ""
              }`}
            >
              <input
                type="radio"
              ...
              <div className="hidden sm:block w-full sm:w-1/2">
                ...
                <p className="text-gray-700 mt-2 text-sm sm:text-base">
                  Follow Any Profile on Facebook & Earn Exciting Rewards &
                  Points
                </p>
              </div>
              <div className="w-full sm:w-1/2 mt-4 sm:mt-0">
                <img
                  src="/Facebook/facebookimage3.png"
                  alt="Follow Profile"
                  className="w-full rounded-lg"
                />
              </div>
...
export default FacebookTaskModal;
